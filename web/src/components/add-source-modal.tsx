...
import { X, GitBranch, Loader2, Key, ShieldCheck, Github } from "lucide-react";
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[10px] text-zinc-500">App installation</div>
                </div>
              </button>
            ...
            <div className="space-y-1.5 animate-in fade-in">
              <div className="flex justify-between items-center">
                ...
                {typeof window !== "undefined" && localStorage.getItem("cf_pat") && (
                  <button
                    type="button"
                    onClick={() => setPatToken(localStorage.getItem("cf_pat") || "")}
