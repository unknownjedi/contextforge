...
func (_c *ConversationCreate) SetProject(v *Project) *ConversationCreate {
...
func (_c *ConversationCreate) check() error {
	if _, ok := _c.mutation.ProjectID(); !ok {
		return &ValidationError{Name: "project_id", err: errors.New(`ent: missing required field "Conversation.project_id"`)}
	}
	if _, ok := _c.mutation.Title(); !ok {
	...
	if len(_c.mutation.ProjectIDs()) == 0 {
		return &ValidationError{Name: "project", err: errors.New(`ent: missing required edge "Conversation.project"`)}
	}
	return nil
}
