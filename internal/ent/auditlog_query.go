...
func (_q *AuditLogQuery) QueryProject() *ProjectQuery {
...
func (_q *AuditLogQuery) WithProject(opts ...func(*ProjectQuery)) *AuditLogQuery {
	query := (&ProjectClient{config: _q.config}).Query()
...
//		GroupBy(auditlog.FieldProjectID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.AuditLog.Query().
//		Select(auditlog.FieldProjectID).
//		Scan(ctx, &v)
...
func (_q *AuditLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AuditLog, error) {
	...
	if query := _q.withProject; query != nil {
		if err := _q.loadProject(ctx, query, nodes, nil,
			func(n *AuditLog, e *Project) { n.Edges.Project = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AuditLogQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*AuditLog, init func(*AuditLog), assign func(*AuditLog, *Project)) error {
...
func (_q *AuditLogQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withProject != nil {
			_spec.Node.AddColumnOnce(auditlog.FieldProjectID)
		}
	}
